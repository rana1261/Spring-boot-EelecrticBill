...
<html>
    <head>
        ...
        <title>Save Successful Page</title>
        ...
        <link rel="stylesheet" href="css/saveSuccessfull.css" type="text/css">
    </head>
    <body>
        <div class="page_margin">
            ...
            <ul>
                ...
                <li><a  class="active" href="Admin_login">Admin</a></li>
            ...
            <div> <img src="image/neulear.jpg" alt="Bill Screen Image" class="image2">
                ...
                <div class="bill_infocontainer">
                    ...
                    <p>Your data have saved successfully.</P> 
