...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/billWaitPage.css" type="text/css">
    </head>
    <body>
        <div class="page_margin">
            ...
            <div> <img src="image/neulear.jpg" alt="Bill Screen Image" class="image2">
                ...
                <div class="bill_infocontainer">
                    ...
                    <p>Your Bill Receipt in process.we need 24 hours for verification purpose. After 24 hours, you will be able to print the Bill Receipt.</P> 
